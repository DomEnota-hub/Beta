...
internal val firstAidTopics = listOf(
    ...
    FirstAidTopic(
        ...
        actions = listOf(
            ...
            "Согревание поражённого участка проводите только если исключено повторное замерзание. Используйте тёплую, не горячую воду и прекратите воздействие холода на весь организм.",
        ...
        dont = listOf(
            ...
            "Не вскрывайте пузыри и не допускайте повторного замерзания после начала согревания."
        )
    ),
    FirstAidTopic(
        id = "bites",
