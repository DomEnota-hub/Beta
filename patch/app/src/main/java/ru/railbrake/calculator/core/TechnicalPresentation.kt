...
private val exactLabels = mapOf(
    ...
    "roof" to "Крыша",
    "cab" to "Кабина",
    "machine_room" to "Машинное отделение",
    "each_section" to "На каждой секции",
    "head_section" to "Головная секция",
    "v" to "В",
    "a" to "А",
    "kw" to "кВт",
    "kpa" to "кПа",
    "mpa" to "МПа",
    "feeds" to "Подаёт питание",
    "pneumatically_operated_by" to "Имеет пневматический привод от",
    "controlled_by" to "Управляется",
    "protects" to "Защищает",
    "measures" to "Измеряет",
    "functional_link" to "Функционально связан",
    "full functional" to "Полная функциональная схема",
    "functional" to "Функциональная схема",
    "functional overlay" to "Функциональное наложение для выбранного исполнения",
    "differential overlay" to "Сравнение отличий выбранного исполнения",
    "variant full" to "Полная схема выбранного исполнения",
    "variant overlay" to "Наложение выбранного исполнения",
    "section view" to "Схема отдельной секции",
    "spatial" to "Схема размещения оборудования",
