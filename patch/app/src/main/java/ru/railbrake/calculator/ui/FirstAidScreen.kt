...
internal val firstAidTopics = listOf(
    FirstAidTopic(
        ...
        actions = listOf(
            ...
            "Откройте дыхательные пути запрокидыванием головы с подъёмом подбородка и оцените нормальное дыхание не более 10 секунд.",
    ...
    FirstAidTopic(
        ...
        actions = listOf(
            ...
            "Откройте дыхательные пути запрокидыванием головы с подъёмом подбородка и оцените нормальное дыхание не более 10 секунд. Удаляйте изо рта только хорошо видимое и доступное инородное тело.",
    ...
    FirstAidTopic(
        ...
        actions = listOf(
            ...
            "Охлаждайте ожог прохладной проточной водой не менее 20 минут, если это возможно и безопасно.",
    ...
    FirstAidTopic(
        ...
        dont = listOf("Не вызывайте рвоту и не давайте еду, питьё или лекарства без указания специалиста.", "Не входите в опасную атмосферу без защиты.")
    ),
    FirstAidTopic(
        id = "chemical",
        ...
        actions = listOf(
            ...
            "Промывайте кожу или глаза большим количеством проточной воды, если паспорт/маркировка вещества не устанавливает другой безопасный порядок.",
