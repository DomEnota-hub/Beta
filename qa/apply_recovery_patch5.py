...
# Step-by-step route: route position is route-specific, but the inspection result is
# the same canonical item in every UI mode.
...
t = rep(t, '''                                    prefs.edit().putBoolean("${entry.id}:gate:$gate", !confirmed).apply()''', '''                                    prefs.edit().putBoolean("gate:$gate", !confirmed).apply()''', "step gate persist")
...
# Checklist/area views share exactly the same item and gate state as the sequential views.
...
t = rep(t, '''                                    prefs.edit().putBoolean("${entry.id}:gate:$gate", !confirmed).apply()''', '''                                    prefs.edit().putBoolean("gate:$gate", !confirmed).apply()''', "checklist gate persist")
