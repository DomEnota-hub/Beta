...
scroll_up_until_visible("Шаг 1 из 81", "Статус: Не проверено")
scroll_up_until_visible("Статус: Не проверено", "Проверено")
tap("Проверено")
...
time.sleep(.5)
scroll_up_until_visible("Найти по симптому или действию", "Найдено: 1")
...
scroll_up_until_visible("Техническая база ВЛ80С", "Недавние материалы")
